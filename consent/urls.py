...
urlpatterns = [
    ...
    path("rosters/", views.consent_rosters, name="rosters"),
    path("rosters/<uuid:roster_id>/delete/", views.consent_delete_roster, name="delete_roster"),
    ...
    path(
        "<uuid:request_id>/recipients/template.csv",
        views.consent_recipients_csv_template,
        name="recipients_csv_template_for_request",
    ),
