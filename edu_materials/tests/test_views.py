...
class EduMaterialViewTests(TestCase):
    ...
    def test_run_view_renders_runtime_data_iframe_and_tracks_views(self):
        ...
        self.assertContains(response, f'href="{reverse("edu_materials:share_board", args=[material.id])}"')
        self.assertContains(response, "data-student-share-board-link")
        self.assertContains(response, "자료 배포 화면으로 돌아가기")
