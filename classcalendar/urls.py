...
urlpatterns = [
    ...
    path("api/message-captures/quick-save/", views.api_message_capture_quick_save, name="api_message_capture_quick_save"),
    ...
    path(
        "api/message-captures/<uuid:capture_id>/analyze/",
        views.api_message_capture_analyze,
        name="api_message_capture_analyze",
    ),
    path(
