...
class SheetbookUiContractTests(SimpleTestCase):
    ...
    def test_sheetbook_calendar_links_use_primary_calendar_route(self):
        ...
        self.assertIn("연결 설정", calendar_tab)
        self.assertIn("달력 단독 화면", calendar_tab)
        ...
        self.assertIn("수첩으로 돌아올 때", calendar_tab)
        ...
        self.assertIn("휴대폰에서는 일정 확인과 일정 1건 추가만 할 수 있어요.", calendar_tab)
