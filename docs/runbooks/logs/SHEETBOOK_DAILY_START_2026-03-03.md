# Sheetbook Daily Start Bundle (2026-03-03 21:12:28)
...
## Next Actions
- 표본 부족량(blockers) 해소 후 bundle+gap summary 재실행: `python scripts/run_sheetbook_daily_start_bundle.py --days 14 --due-date 2026-03-03 && python scripts/run_sheetbook_sample_gap_summary.py --days 14`
...
- 로컬 리허설용 표본 생성(운영 판정 분리): workspace_home_opened 5건, home_source_sheetbook_created 5건: `python scripts/run_sheetbook_collect_pilot_samples.py --home-collection-mode direct-event --clear-before --home-count 5 --create-count 5 --archive-event-count 0`
