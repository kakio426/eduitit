...
- 스테이징/운영 실계정 점검 결과를 한 번에 PASS 반영: `python scripts/run_sheetbook_signoff_decision.py --set staging_real_account_signoff=PASS:staging-ok --set production_real_account_signoff=PASS:prod-ok`
- 스테이징 실계정 점검 후 상태를 PASS로 반영: `python scripts/run_sheetbook_signoff_decision.py --set staging_real_account_signoff=PASS:staging-ok`
- 운영 실계정 점검 후 상태를 PASS로 반영: `python scripts/run_sheetbook_signoff_decision.py --set production_real_account_signoff=PASS:prod-ok`
