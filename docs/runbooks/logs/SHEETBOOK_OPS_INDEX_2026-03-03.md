...
- [daily_start] 로컬 리허설 표본 수집/검증 후 clear 및 bundle+gap summary 상태 복구: `python scripts/run_sheetbook_collect_pilot_samples.py --home-collection-mode direct-event --clear-before --home-count 5 --create-count 5 --action-count 3 --archive-event-count 5 --output docs/handoff/smoke_sheetbook_collect_samples_bundle_latest.json && python scripts/run_sheetbook_daily_start_bundle.py --days 14 --allow-pilot-hold-for-beta --due-date 2026-03-04 && python scripts/run_sheetbook_sample_gap_summary.py --days 14 && python scripts/run_sheetbook_collect_pilot_samples.py --clear-only --output docs/handoff/smoke_sheetbook_collect_samples_bundle_clear_latest.json && python scripts/run_sheetbook_daily_start_bundle.py --days 14 --allow-pilot-hold-for-beta --due-date 2026-03-04 && python scripts/run_sheetbook_sample_gap_summary.py --days 14`
...
- [sample_gap] 로컬 리허설용 아카이브 이벤트 5건 생성(운영 판정 분리): `python scripts/run_sheetbook_collect_pilot_samples.py --home-collection-mode direct-event --home-count 0 --create-count 0 --archive-event-count 5 --output docs/handoff/smoke_sheetbook_collect_archive_events_latest.json`
