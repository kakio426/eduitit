# Sheetbook Pilot Event Log (2026-03-03)

기록 시각: 2026-03-03 12:36  
...
|---|---|---|---:|---:|---:|---:|---:|---:|---|---|
| 2026-03-03 | local-pilot-baseline | baseline | 0 | 5 | 5 | 3 | 100.0 | 60.0 | 파일럿 실사용 트래픽 미유입 | 파일럿 계정 3개 학급 대상 홈 진입/수첩 생성/기능 실행 안내(운영자, 03-02) |
