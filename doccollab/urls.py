...
urlpatterns = [
    ...
    path("rooms/<uuid:room_id>/assistant/analyze/", views.assistant_analyze, name="assistant_analyze"),
    path("rooms/<uuid:room_id>/assistant/ask/", views.assistant_ask, name="assistant_ask"),
