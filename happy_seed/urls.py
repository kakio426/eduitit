...
urlpatterns = [
    ...
    # Student CRUD
    path('<uuid:classroom_id>/students/manage/', views.student_manage, name='student_manage'),
    ...
    # HTMX Partials
    path('<uuid:classroom_id>/partials/workspace/', views.classroom_workspace_partial, name='classroom_workspace_partial'),
