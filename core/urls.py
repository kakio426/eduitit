...
urlpatterns = [
    ...
    path('service-guides/', views.service_guide_list, name='service_guide_list'),
    path('service-guides/<int:pk>/', views.service_guide_detail, name='service_guide_detail'),
    path('manuals/', views.service_guide_list, name='legacy_service_guide_list'),
    path('manuals/<int:pk>/', views.service_guide_detail, name='legacy_service_guide_detail'),
