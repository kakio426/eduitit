...
TOOLS_DATA = [
    ...
    },
    {
        ...
        'desc': '서버를 직접 챙기지 않아도 되는 백엔드 서비스입니다. 데이터베이스, 로그인, 파일 저장소를 한곳에서 묶어 빠르게 운영할 수 있습니다.',
    ...
    # ========== 디자인 & 협업 (Design & Collaboration) ==========
    {
        ...
        'summary': '디자인을 실제 화면 제작으로 넘기기 쉬워지는 Dev Mode와 AI 디자인 도우미가 더 강력해졌습니다.',
        'details': [
    ...
    # ========== 모니터링 & 운영 (Ops & Monitoring) ==========
    {
        ...
        'desc': '서비스의 든든한 방패입니다. 웹사이트에서 어떤 오류가 생겼는지 빠르게 확인하고, 문제가 커지기 전에 원인을 찾는 데 도움이 됩니다.',
