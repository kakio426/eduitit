...
urlpatterns = [
    ...
    path("class/<uuid:classroom_id>/htmx/my-bank/", views.htmx_my_bank_library, name="htmx_my_bank_library"),
    path("class/<uuid:classroom_id>/htmx/my-bank/random-select/", views.htmx_my_bank_random_select, name="htmx_my_bank_random_select"),
