...
SHEETBOOK_CONSENT_CLEANUP_TARGET_RATE = float(os.environ.get('SHEETBOOK_CONSENT_CLEANUP_TARGET_RATE', '30'))
SHEETBOOK_CONSENT_CLEANUP_MIN_SAMPLE = int(os.environ.get('SHEETBOOK_CONSENT_CLEANUP_MIN_SAMPLE', '5'))
SHEETBOOK_CONSENT_CLEANUP_UNDO_ALERT_RATE = float(
    os.environ.get('SHEETBOOK_CONSENT_CLEANUP_UNDO_ALERT_RATE', '20')
)
SHEETBOOK_CONSENT_CLEANUP_UNDO_MIN_SAMPLE = int(
    os.environ.get('SHEETBOOK_CONSENT_CLEANUP_UNDO_MIN_SAMPLE', '5')
)
