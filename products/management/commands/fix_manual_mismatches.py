...
MANUAL_UPDATES: dict[str, ManualPayload] = {
    ...
    "몽글몽글 미술 수업": ManualPayload(
        ...
        description="유튜브 분석부터 단계 편집, 수업 실행까지 실제 사용 순서로 안내합니다.",
        sections=[
            SectionPayload(
                title="유튜브 영상 기반 초안 만들기",
                badge_text="Step 1",
                content=(
                    "1. /artclass/ 에서 유튜브 영상 URL을 입력합니다.\n"
                    "2. AI 수업 설계 버튼을 눌러 단계 초안을 생성합니다.\n"
                    "3. 영상 URL이 올바르면 미리보기 화면도 함께 확인할 수 있습니다."
                ),
            ),
            SectionPayload(
                title="단계 편집",
                badge_text="Step 2",
                content=(
                    "1. 단계 추가로 수업 단계를 직접 늘리거나 줄입니다.\n"
                    "2. 각 단계별로 설명을 수정하고 이미지 첨부/클립보드 붙여넣기를 사용합니다.\n"
                    "3. 자동 전환 간격(초)을 설정해 수업 템포를 맞춥니다."
                ),
            ),
            SectionPayload(
                title="교실 실행",
                badge_text="Step 3",
                content=(
                    "1. 수업 시작하기를 누르면 교실 화면으로 전환됩니다.\n"
                    "2. 라이브러리에서 다른 선생님의 공유 수업도 참고할 수 있습니다."
                ),
            ),
        ],
    ),
