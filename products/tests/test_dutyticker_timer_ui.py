...
class DutyTickerTimerUiTests(TestCase):
    ...
    def test_dutyticker_page_renders_minute_step_timer_controls(self):
        ...
        self.assertContains(response, 'id="missionAutomationNameInput"')
        self.assertContains(response, 'id="missionAutomationStartInput"')
        self.assertContains(response, 'id="missionAutomationEndInput"')
        self.assertContains(response, 'id="missionAutomationMinutesInput"')
