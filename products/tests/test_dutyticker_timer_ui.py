...
class DutyTickerTimerUiTests(TestCase):
    ...
    def test_dutyticker_page_renders_minute_step_timer_controls(self):
        ...
        self.assertContains(response, 'id="missionAutomationNewBtn"')
        ...
        self.assertContains(response, 'id="missionAutomationEnabledInput"')
        ...
        self.assertContains(response, 'id="missionAutomationCreateBtn"')
        self.assertContains(response, 'id="missionAutomationUpdateBtn"')
        self.assertContains(response, 'id="missionAutomationDeleteBtn"')
    ...
    def test_timer_script_contains_safety_and_restore_methods(self):
        ...
        self.assertIn('createMissionAutomation()', script)
        self.assertIn('updateSelectedMissionAutomation()', script)
        self.assertIn('deleteSelectedMissionAutomation()', script)
        ...
        self.assertIn('selectMissionAutomationSlot(slotCode)', script)
