...
class DutyTickerTimerUiTests(TestCase):
    ...
    def test_dutyticker_page_renders_minute_step_timer_controls(self):
        ...
        self.assertContains(response, 'id="missionPhrasePanelToggleBtn"')
        self.assertContains(response, 'id="missionPhrasePanelBody" class="hidden')
    ...
    def test_timer_script_contains_safety_and_restore_methods(self):
        ...
        self.assertIn('toggleMissionPhrasePanel(forceExpanded = null)', script)
