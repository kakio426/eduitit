...
urlpatterns = [
    ...
    path("external/snapshot/", views.external_snapshot_view, name="external_snapshot"),
    path("external/push-text/", views.external_push_text_view, name="external_push_text"),
    path("external/push-file/", views.external_push_file_view, name="external_push_file"),
    ...
    path("c/<slug:slug>/send-file/", views.send_file_view, name="send_file"),
    ...
    path("c/<slug:slug>/items/<int:item_id>/delete/", views.delete_item_view, name="delete_item"),
    path("c/<slug:slug>/items/<int:item_id>/download/", views.item_download_view, name="item_download"),
