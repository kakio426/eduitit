...
| 순서 | 서비스 | 라우트 | 분석 대상 | 상태 | 발견 이슈 | 수정 여부 | 검증 |
|---:|---|---|---|---|---|---|---|
| 10 | autoarticle/encyclopedia/guide_recorder/version_manager/handoff/qrgen | `/autoarticle/`, `/encyclopedia/`, `/guide-recorder/`, `/version-manager/`, `/handoff/`, `/qrgen/` | 보조 업무 도구 | 다음 진행 | 미분석 | 미정 | 대기 |
...
- 사용자가 `다음 진행해줘`라고 하면 10번 `보조 업무 도구`부터 진행한다.
