...
class TestDeepSeekStreaming(TestCase):
    ...
    def test_deepseek_streaming_success(self, mock_openai):
    ...
    def test_deepseek_streaming_empty(self, mock_logger, mock_openai):
    ...
    @patch.dict(os.environ, {'MASTER_DEEPSEEK_API_KEY': 'test-key'})
    @patch('fortune.views.OpenAI')
    def test_deepseek_api_error(self, mock_openai):
