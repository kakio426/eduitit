...
1. 선생님의 정체성은 반드시 상단 [SSOT Data]의 'Day' 첫 글자입니다. 년주(Year)의 글자를 자신으로 묘사하면 안 됩니다.
...
## 📌 1. 핵심 요약
- {data['name']} 선생님의 성향을 자연물에 비유하여 3줄로 요약

## 📜 2. 사주 명식
- 나의 중심 에너지: 자연물 비유로 설명
- 나머지 기운: 월주/년주/시주를 자연물로 풀어서 설명
...
[System Logic (SSOT)] 상단 데이터를 절대 기준으로 해석하세요. 서론이나 별도 제목은 쓰지 마세요.
1. 사용자의 정체성은 반드시 상단 [SSOT Data]의 'Day' 첫 글자입니다. 다른 글자와 혼동하지 마세요.
...
## 📌 1. 핵심 요약
- {data['name']}님의 성향을 자연물에 비유하여 3줄로 요약
...
2. 반드시 일주(Day)의 첫 글자를 기준으로 분석하세요.
3. 응답은 반드시 줄바꿈 후 `## `으로 시작하세요.
