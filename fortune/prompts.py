...
[Output Format - **절대 주의: 첫 글자는 반드시 '#'으로 시작하며, 그 이전에 어떠한 문자나 이모티콘도 넣지 마십시오.**]
## 📌 1. 핵심 요약 (3줄 요약)
- {data['name']} 선생님의 성향(일주의 천간 오행 비유 필수)과 핵심 메시지 요약
...
## 📌 1. 핵심 요약 (3줄 요약)
- {data['name']}님의 성향(일주의 천간 오행 비유 필수)과 핵심 메시지 요약
